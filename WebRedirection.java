...
public class WebRedirection {
    ...
    private static final String secretKey = "cutWka8YGt?jC$yY";
    private static final String fi = "samridhai-lsp";
    // private static final String fi = "LSP";
    ...
    public static void main(String[] args) {
        ...
        if (encData != null) {
            ...
            String redirectUrl = String.format("https://reactjssdk.finvu.in/?ecreq=%s&reqdate=%s&fi=%s&requestorType=fWdg",
        encData, salt, xoredFI);
